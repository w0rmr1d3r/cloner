...
def get_system_cores() -> int:
    ...
    It does so by calling the OS to retrieve such information. If it cannot be retrieved, it will return -1.
...
def inform_cpu(selected_threads: int):
    """
    Logs a warning if the number of given threads is different from the amount of cores the system running it has.
